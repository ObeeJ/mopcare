...
func connectDB() (*sql.DB, error) {
	connStr := os.Getenv("SUPABASE_DB_URL") // Get from environment variable
	if connStr == "" {
		return nil, errors.New("supabase_db_url environment variable is not set")
	}
